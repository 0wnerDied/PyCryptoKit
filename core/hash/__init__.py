...
HASH_ALGORITHMS: Dict[str, Tuple[Type[HashBase], bool, str, Dict[str, Any]]] = {
    ...
    "SHA3-224": (SHA3_224Hash, True, "SHA3-224 安全哈希算法", {}),
    "SHA3-256": (SHA3_256Hash, True, "SHA3-256 安全哈希算法", {}),
    "SHA3-384": (SHA3_384Hash, True, "SHA3-384 安全哈希算法", {}),
    "SHA3-512": (SHA3_512Hash, True, "SHA3-512 安全哈希算法", {}),
    "SHAKE-128": (SHAKE128Hash, True, "SHAKE128 安全哈希算法", {}),
    "SHAKE-256": (SHAKE256Hash, True, "SHAKE256 安全哈希算法", {}),
    "BLAKE2b": (
        BLAKE2bHash,
        True,
        "BLAKE2b 哈希算法",
